import { ChartBar as BarChart3, Gem, Users, Package, MapPin, DollarSign, Circle as HelpCircle, Bell, Settings, LogOut } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Init • Node #1</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-slate-600">Region: West Africa</span>
            </div>
              ...
              <div className="relative">
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-slate-200">
                    ...
                    <button className="w-full text-left px-4 py-2 hover:bg-slate-50 flex items-center gap-2 text-slate-700 border-t border-slate-200">
